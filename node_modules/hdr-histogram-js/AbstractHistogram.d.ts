...
export declare abstract class AbstractHistogram extends AbstractHistogramBase {
    ...
    private updatedMaxValue(value);
    private updateMinNonZeroValue(value);
    private resetMinNonZeroValue(minNonZeroValue);
    ...
    private computeCountsArrayIndex(bucketIndex, subBucketIndex);
    /**
    ...
    private recordCountAtValue(count, value);
    /**
    ...
    private recordValueWithCountAndExpectedInterval(value, count, expectedIntervalBetweenValueSamples);
    /**
